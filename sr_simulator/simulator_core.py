...
from per_partner_simulator import per_partner_simulator
...
class simulator_core:
    def __init__(self, partners_to_involve_in_simulation, partners_to_not_involve_in_simulation, path_to_data="../data/"):
        ...
        self.partners_to_not_involve_in_simulation = partners_to_not_involve_in_simulation
        ...
        for partner_id in self.partners_to_involve_in_simulation:
            self.product_list_optimizer.append(per_partner_simulator(partner_id))
    ...
    def next_day(self):
        ...
        # TODO call next day from per_partner
        # TODO return gain
